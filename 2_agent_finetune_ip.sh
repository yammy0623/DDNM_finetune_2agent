...
mkdir -p model/inpainting_imagenet_2_agents_A2C_5
# IP 5
# train ours (1st subtask)
export CUDA_VISIBLE_DEVICES=0
python train.py --ni --config imagenet_256.yml --exp $EXP --path_y imagenet --eta 0.85 --deg "inpainting" --sigma_y 0. -i imagenet_inpainting --target_steps 5 --seed $SEED
