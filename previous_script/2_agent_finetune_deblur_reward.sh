...
mkdir -p model/deblur_gauss_imagenet_2_agents_A2C_5_a07
# Deblur
# train ours (1st subtask)
export CUDA_VISIBLE_DEVICES=1
# train ours (1st subtask)
python train.py --ni --config imagenet_256.yml --exp $EXP --path_y imagenet --eta 0.85 --deg "deblur_gauss" --sigma_y 0. -i imagenet_deblur_5_a07_  --target_steps 5 --seed $SEED
# eval ours (1st subtask)
python eval.py --ni --config imagenet_256.yml --exp $EXP --path_y imagenet --eta 0.85 --deg "deblur_gauss" --sigma_y 0. -i imagenet_deblur_5_a07_eval --target_steps 5 --eval_model_name deblur_gauss_imagenet_2_agents_A2C_5_a07  --subtask1 >> model/deblur_gauss_imagenet_2_agents_A2C_5_a07/subtask1.txt
# train ours (2nd subtask)
python train.py --ni --config imagenet_256.yml --exp $EXP --path_y imagenet --eta 0.85 --deg "deblur_gauss" --sigma_y 0. -i imagenet_deblur_5_a07_  --target_steps 5 --second_stage --seed $SEED
# eval ours
python eval.py --ni --config imagenet_256.yml --exp $EXP --path_y imagenet --eta 0.85 --deg "deblur_gauss" --sigma_y 0. -i imagenet_deblur_5_a07_eval --target_steps 5 --eval_model_name deblur_gauss_imagenet_2_agents_A2C_5_a07 >> model/deblur_gauss_imagenet_2_agents_A2C_5_a07/2_agents.txt
