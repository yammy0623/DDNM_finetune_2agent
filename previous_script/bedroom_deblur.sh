...
# python eval.py --ni --config $CONFIG --exp $EXP --path_y $PATHY --eta 0.85 --deg $DEG --deg_scale 4 --sigma_y 0. -i $PATHY"_"$DEG"_""$STEP""eval" --target_steps $STEP --eval_model_name $DEG"_"$PATHY"_A2C_""$STEP" --subtask1 >> "model/"$DEG"_"$PATHY"_A2C_"$STEP"/sub1.txt"
...
# eval ours
# python eval.py --ni --config $CONFIG --exp $EXP --path_y $PATHY --eta 0.85 --deg $DEG --deg_scale 4 --sigma_y 0. -i $PATHY"_"$DEG"_""$STEP""eval" --target_steps $STEP --eval_model_name $DEG"_"$PATHY"_A2C_""$STEP" >> "model/"$DEG"_"$PATHY"_A2C_"$STEP"/sub2.txt"
...
# python eval.py --ni --config $CONFIG --exp $EXP --path_y $PATHY --eta 0.85 --deg $DEG --deg_scale 4 --sigma_y 0. -i $PATHY"_"$DEG"_""$STEP""eval" --target_steps $STEP --eval_model_name $DEG"_"$PATHY"_A2C_""$STEP" --subtask1 >> "model/"$DEG"_"$PATHY"_A2C_"$STEP"/sub1.txt"
# # train ours (2nd subtask)
# python train.py --ni --config $COdNFIG --exp $EXP --path_y $PATHY --eta 0.85 --deg $DEG --deg_scale 4 --sigma_y 0. -i $PATHY"_"$DEG"_""$STEP" --target_steps $STEP --second_stage --seed $SEED
# # eval ours
# python eval.py --ni --config $CONFIG --exp $EXP --path_y $PATHY --eta 0.85 --deg $DEG --deg_scale 4 --sigma_y 0. -i $PATHY"_"$DEG"_""$STEP""eval" --target_steps $STEP --eval_model_name $DEG"_"$PATHY"_A2C_""$STEP" >> "model/"$DEG"_"$PATHY"_A2C_"$STEP"/sub2.txt"
